...
/**
 * Top menu bar component with logo and navigation links
 * Matches the IDE-style interface with dark theme
 */
export default function MenuBar({ onSettingsClick }: MenuBarProps) {
  return (
